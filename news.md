...
<div class="summary-section mb-5">
    ...
    <div class="claude-summary mb-4">
        <div class="summary-header">
            ...
            <small class="text-muted">Generated at 13:32 today | <a href="/news-2025-08-26/">Permanent link</a></small>
        </div>
        <div class="summary-content">
<p><strong>Security</strong>: <a href="https://news.google.?oc=5" target="_blank" class="alert-link">0-Click Zendesk Account Takeover Vulnerability Enables Access to all Zendesk Tickets</a> - CyberSecurityNews</p>
        </div>
    ...
    <div class="collapsed-articles">
        ...
        <div class="collapse" id="week-list">
            ...
            <article class="feed-item border-bottom py-2 mt-3">
                ...
                <small class="text-muted"><i class="far fa-clock"></i> 3 days ago</small>
            </article>
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
...
<div class="summary-section mb-5">
    <h2 class="summary-title">
        ...
        This Month
        <span class="badge badge-info ml-2">35 articles</span>
    </h2>
    
    <div class="collapsed-articles">
        <small class="text-muted">
            <a href="#" data-toggle="collapse" data-target="#month-list" class="text-decoration-none">
                <i class="fas fa-chevron-right"></i> Show 35 articles from this month
            </a>
        </small>
        <div class="collapse" id="month-list">
            ...
            <article class="feed-item border-bottom py-2 mt-3">
                ...
                <small class="text-muted"><i class="far fa-clock"></i> 10 days ago</small>
            </article>
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
            ...
            <article class="feed-item border-bottom py-2 mt-3">
                ...
                <small class="text-muted"><i class="far fa-clock"></i> 18 days ago</small>
            </article>
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
            ...
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
                    <a href="https://support.zendesk.com/hc/en-us/articles/9571192214810-Announcing-the-auto-assist-tab-in-the-Zendesk-Copilot-Agent-productivity-dashboard" class="text-dark">Announcing the auto assist tab in the Zendesk Copilot: Agent productivity dashboard</a>
                    <span class="source-badge">Zendesk Announcements</span>
                </h6>
                <small class="text-muted"><i class="far fa-clock"></i> 19 days ago</small>
            </article>
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
                    <a href="https://support.zendesk.com/hc/en-us/articles/9570970783002-Announcing-the-removal-of-the-Connect-other-option-to-add-support-addresses" class="text-dark">Announcing the removal of the 'Connect other' option to add support addresses</a>
                    <span class="source-badge">Zendesk Announcements</span>
                </h6>
                <small class="text-muted"><i class="far fa-clock"></i> 19 days ago</small>
            </article>
            ...
            <article class="feed-item border-bottom py-2 mt-3">
                ...
                <small class="text-muted"><i class="far fa-clock"></i> 27 days ago</small>
            </article>
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
            ...
            <article class="feed-item border-bottom py-2 mt-3">
                <h6 class="item-title">
                    <a href="https://news.google.com/rss/articles/CBMihgFBVV95cUxPUmFZYWRKTm1IZ3A0ckhKR3hzMER2RjFna3pkWU9rczFkRFByZUxoRGR5b0lGQlY1bUd2SEgyc3VjdWpJMGpBWFdqd080OGNBaWNTYTI4aDA2YnR3X0F5UWlTbDJrTk50bGJnZE5OYlpxX1J5MDAzaXR4aDlqMHktUkljWWI5Zw?oc=5" class="text-dark">Zendesk: Why Half of People Trust AI Assistants - AI Magazine</a>
