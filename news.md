...
<div class="summary-section mb-5">
    ...
    <div class="claude-summary mb-4">
        <div class="summary-header">
            ...
            <small class="text-muted">Generated at 15:35 today | <a href="/news-2025-08-27/">Permanent link</a></small>
        </div>
        <div class="summary-content">
<p>Critical:</p>
            <p>[6, 7] Vulnerability allows hackers to hijack Zendesk accounts and access all tickets.</p>
            <p>Latest:</p>
            <p><a href="#latest-article-2" class="ref-link" data-section="latest">[2]</a> Announcing end user separation for department spaces.</p>
            <p><a href="#latest-article-3" class="ref-link" data-section="latest">[3]</a> New feature enables automated ticket redaction via triggers.</p>
            <p><a href="#latest-article-5" class="ref-link" data-section="latest">[5]</a> Release notes for updates through 2025-08-22.</p>
            <p>Meanwhile:</p>
            <p>[1, 4] Former Zendesk headquarters in San Francisco headed to auction after steep drop in valuation.</p>
        </div>
...
<div class="summary-section mb-5">
    ...
    <div class="claude-summary mb-4">
        ...
        <div class="summary-content">
<p>Zendesk News Digest:</p>
            <p><strong>Critical:</strong></p>
            <p>- Service incident on July 25 impacted adherence feature <a href="#week-article-3" class="ref-link" data-section="week">[3]</a></p>
            <p>- Performance degradation and failing calls in Zendesk Sales on July 31 <a href="#week-article-6" class="ref-link" data-section="week">[6]</a></p>
            <p><strong>This week:</strong></p>
            <p>- Announcing enhanced dynamic filtering for lookup relationships <a href="#week-article-2" class="ref-link" data-section="week">[2]</a></p>
            <p>- Announcing API support for WhatsApp Flows <a href="#week-article-5" class="ref-link" data-section="week">[5]</a></p>
            <p>- Announcing import enhancements for Exchange and Gmail connectors <a href="#week-article-7" class="ref-link" data-section="week">[7]</a></p>
            <p><strong>Meanwhile:</strong></p>
            <p>- TTEC partners with Zendesk to deliver AI-driven CX solutions <a href="#week-article-1" class="ref-link" data-section="week">[1]</a></p>
            <p>- Zendesk QA user and license management moves to Admin Center <a href="#week-article-9" class="ref-link" data-section="week">[9]</a></p>
            <p>- Scheduled maintenance for Zendesk Sales database on September 9 <a href="#week-article-8" class="ref-link" data-section="week">[8]</a></p>
        </div>
    </div>
...
<div class="summary-section mb-5">
    ...
    <div class="claude-summary mb-4">
        ...
        <div class="summary-content">
<p><strong>Critical</strong></p>
            <p>- Service incidents reported on <a href="#month-article-1" class="ref-link" data-section="month">[1]</a> QA access issues & 5xx errors, <a href="#month-article-8" class="ref-link" data-section="month">[8]</a> account integration issues, <a href="#month-article-10" class="ref-link" data-section="month">[10]</a> workflow disruptions, and <a href="#month-article-11" class="ref-link" data-section="month">[11]</a> AI agent delays.</p>
            <p><strong>This month</strong></p>
            <p>- New features include <a href="#month-article-5" class="ref-link" data-section="month">[5]</a> email authentication, <a href="#month-article-7" class="ref-link" data-section="month">[7]</a> external OAuth page, <a href="#month-article-16" class="ref-link" data-section="month">[16]</a> agent copilot auto-assist, and <a href="#month-article-18" class="ref-link" data-section="month">[18]</a> excluded terms for AI translations.</p>
            <p>- Release notes published through <a href="#month-article-4" class="ref-link" data-section="month">[4]</a> 2025-08-15 and <a href="#month-article-17" class="ref-link" data-section="month">[17]</a> 2025-08-08.</p>
            <p><strong>Meanwhile</strong></p>
            <p>- <a href="#month-article-2" class="ref-link" data-section="month">[2]</a> Zendesk competitor backed by Andreessen Horowitz and Bain.</p>
            <p>- <a href="#month-article-9" class="ref-link" data-section="month">[9]</a> Zendesk CTO discusses the new era of customer experience.</p>
            <p>- <a href="#month-article-13" class="ref-link" data-section="month">[13]</a> Zendesk boosts support efficiency with GPT-5 integration.</p>
            <p>- <a href="#month-article-14" class="ref-link" data-section="month">[14]</a> Zendesk expands to meet rising AI-driven demand.</p>
            <p>- <a href="#month-article-19" class="ref-link" data-section="month">[19]</a> Zendesk adopts outcome-based pricing model.</p>
            <p>- <a href="#month-article-20" class="ref-link" data-section="month">[20]</a> Zendesk increases LatAm investments to capture AI agent momentum.</p>
        </div>
    </div>
