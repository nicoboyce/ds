...
<script type="application/ld+json">
{
  ...
  "datePublished": "2025-10-22T19:00:08+00:00",
  "dateModified": "2025-10-22T19:00:08+00:00",
  "author": {
    "@type": "Organization",
    "name": "Deltastring",
  ...
  "description": "Latest: Service Incident - October 23, 2025 | Multiple pods - All messaging tickets are not assigned to human agents by the system",
  "mainEntityOfPage": {
    "@type": "WebPage",
...
<div class="row">
    <div class="col-lg-12">
        <p class="text-muted text-center mb-2">Latest: Service Incident - October 23, 2025 | Multiple pods - All messaging tickets are not assigned to human agents by the system</p>
        <p class="text-muted text-center small mb-4">
            <i class="far fa-clock"></i> Last updated: 19:00 GMT, 22 October 2025
        </p>
    </div>
</div>
    ...
    <div class="category-section mb-4">
        ...
        <article class="feed-item border-bottom py-3">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="item-title">
                        <a href="https://support.zendesk.com/hc/en-us/articles/9858456215194-Service-Incident-October-23-2025-Multiple-pods-All-messaging-tickets-are-not-assigned-to-human-agents-by-the-system" class="text-dark">Service Incident - October 23, 2025 | Multiple pods - All messaging tickets are not assigned to human agents by the system</a>
                        <span class="source-badge">Zendesk Service Notifications</span>
                    </h5>
                    <p class="item-summary text-muted">
                        https://support.zendesk.com/hc/en-us/articles/9858456215194-Service-Incident-October-23-2025-Multiple-pods-All-messaging-tickets-are-not-assigned-to-human-agents-by-the-system
                    </p>
    ...
    <div class="dont-miss mb-4">
        <div class="card border-warning">
            ...
            <div class="card-body">
                ...
                <p class="mb-2">This article highlights a critical vulnerability in Zendesk's authentication system, which could allow attackers to launch email bombing campaigns, potentially disrupting customer service operations and exposing sensitive data, making it a crucial read for Zendesk administrators.</p>
