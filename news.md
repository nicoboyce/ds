...
<div class="summary-section mb-5">
    ...
    <div class="category-section mb-4">
        ...
        <article class="feed-item border-bottom py-3">
            ...
            <h6 class="item-title">
                <a href="https://support.zendesk.com/hc/en-us/articles/9627766183194-Announcing-the-unified-request-view" class="text-dark">Announcing the unified request view</a>
                <span class="source-badge">Zendesk Announcements</span>
            </h6>
            <small class="text-muted">
                <i class="far fa-clock"></i> 27 days ago
            </small>
        </article>        </div>
    </div>
